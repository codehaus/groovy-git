...
public class WarningMessage extends LocatedMessage {
  ...
  // WARNING LEVELS
    ...
    *
    * @param actual the warning level.
    * @param limit the upper bound for relevance.
    * @return whether the level is a relevant one.
    */
    ...
    *
    * @param importance the upper bound for relevance.
    * @return whether the level is a relevant one.
    */
