...
public @interface AnnotationCollector {
     ...
     * both. The default is {@code org.codehaus.groovy.transform.AnnotationCollectorTransform}.
     * Custom processors need to extend that class.
     *
     * @return the {@code String} describing the processor.
     */
